 ...
 *                            np.ndarray[DTYPE_t, ndim=1] ns,
 */
  __pyx_tuple__3 = PyTuple_Pack(15, __pyx_n_s_s, __pyx_n_s_t, __pyx_n_s_ns, __pyx_n_s_nt, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_ledger, __pyx_n_s_ns_i, __pyx_n_s_nt_i, __pyx_n_s_s_j, __pyx_n_s_t_k, __pyx_n_s_lns, __pyx_n_s_ls, __pyx_n_s_ind); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(4, 0, 15, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_deepgraph__find_selected_indices, __pyx_n_s_find_selected_indices, 25, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
